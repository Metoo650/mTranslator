...
def maker(message):
	bot.send_message(message.chat.id, "🤖Bot Kana Kan hojjate: @Lencho24")
...
def callback(callback):
	...
	if callback.data =="next1":
		...
		bot.send_message(callback.message.chat.id, f"✋{callback.from_user.first_name} Baga Nagaan Dhuftan. Ani Bootii Afaan barbaaddan gara Afaan feetaniitti isiniif jijjiiruudha. <b>Afaan Oromoo</b> jechuudha.\nSirreefama Afaanii jijjiiruuf /set kan jedhu cuqaasaa! Amma barreeffama barbaaddan anatti ergaa🔍", parse_mode ="html")
